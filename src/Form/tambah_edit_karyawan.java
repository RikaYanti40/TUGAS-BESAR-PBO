...
public class tambah_edit_karyawan extends javax.swing.JDialog {
    
    Connection conn = new koneksi_mysql().getConnection();
    
    public tambah_edit_karyawan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cek_judul();
    }
    ...
    private void initComponents() {
        ...
        c_jk.setBackground(new java.awt.Color(204, 102, 0));
        ...
        b_simpan.setBackground(new java.awt.Color(255, 255, 255));
        b_simpan.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        b_simpan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/16.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tambah_edit_karyawan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                tambah_edit_karyawan dialog = new tambah_edit_karyawan(new javax.swing.JFrame(), true);
