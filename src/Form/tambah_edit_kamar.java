 ...
 * @author 1001010
 */
public class tambah_edit_kamar extends javax.swing.JDialog {

    public tambah_edit_kamar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        c_tipe_kamar.setBackground(new java.awt.Color(204, 102, 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tambah_edit_kamar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                tambah_edit_kamar dialog = new tambah_edit_kamar(new javax.swing.JFrame(), true);
